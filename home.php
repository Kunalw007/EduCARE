...
<body>
    ...
    <div class="banner">
        <div class="navbar">
            <div class="logo"><a href="#">EduCARE</a></div>
            <ul>
                <li><a href="res_home.php">Resources</a></li>
                <li><a href="donate.php">Donate</a></li>
                <li><a href="about_us.php">About</a></li>
                <li><a id="myid" href="register.php">
                </a></li>
            </ul>
        </div>
        <div class="content">
            <h1>"For it is in giving that we receive."</h1>
        ...
        <div class="footer">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
              ...
              <li><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
